            ...
            <nav className="nav flex-column">
                ...
                <div className="collapse" id="masterCollapse">
                    <ul className="list-unstyled ps-4">
                        ...
                        <li><Link className={`nav-link sidebar-links ${isActive('/driver') ? 'active' : ''}`} to="/driver">Driver</Link></li>
                        <li><Link className={`nav-link sidebar-links ${isActive('/vendor') ? 'active' : ''}`} to="/vendor">Vendor</Link></li>
                        <li><Link className={`nav-link sidebar-links ${isActive('/user') ? 'active' : ''}`} to="/user">User</Link></li>
                        <li><Link className={`nav-link sidebar-links ${isActive('/fleet') ? 'active' : ''}`} to="/fleet">Fleet</Link></li>
                    </ul>
                </div>
