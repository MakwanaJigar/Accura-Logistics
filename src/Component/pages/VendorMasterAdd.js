...
const VendorMasterAdd = () => {
  const [selectedSupplier, setSelectedSupplier] = useState([]);
    ...
    if (value && !selectedSupplier.includes(value)) {
    ...
    <div className="container-fluid">
      <div className="main-content">
        <p className="main-container-title">
          ...
          <i className="fa-solid fa-angles-right" /> Warehouse Add
        </p>
        ...
        <div className="py-5">
          ...
          <form className="challan-add-main-right-container pb-3">
            ...
            <div className="border p-4 rounded client-add-box">
              <h4 className="fw-bold mb-4 pb-2 border-bottom">Supplier</h4>
              <div>
                <div className=" mb-4 border-bottom border-1 pb-3">
                  <div className="card-body">
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          {/* Input field showing selected suppliers */}
                          <input
                            type="text"
                            className="form-control mt-2"
                            placeholder="Selected suppliers"
                            value={selectedSupplier.join(", ")}
                            readOnly
                          />
                        </div>
                      </div>
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <input name="pan_card" className="form-control" />
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label className="form-label">% Of TDS Applicable*</label>
                          <input name="pan_card" className="form-control" />
                        </div>
                      </div>
                    </div>
